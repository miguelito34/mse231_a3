...
### Getting Set Up
1. Clone the GitHub repo into a directory of your choosing. While this can be done on your local machine, it is recommended to use a remote server.
```
git clone git@github.com:miguelito34/mse231_a3.git
cd mse231_a3/
```
